...
// (import processing.serial.* is in PadViz4.pde — must stay in main tab)
...
class DataSource {
    ...
    // 15-col full:  seq, timestamp_ms, ax, ay, az, qw, qx, qy, qz, roll, pitch, yaw, sc, cpm, hz
    // 10-col:       timestamp_ms, qw, qx, qy, qz, roll, pitch, yaw, sc, cpm
    // 6-col:        timestamp_ms, roll, pitch, yaw, sc, cpm
