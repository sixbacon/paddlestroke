...
class DataSource {
    ...
    // GRV counterpart of meanQuat() — same antipodal-sign handling, reads
    // grvQw/x/y/z instead of qw/x/y/z. Caller must check hasGrv first;
    // returns identity on a v8.13-pre file where GRV is never populated.
