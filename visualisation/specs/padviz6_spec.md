...
**Verification.** Compiles clean (`processing-java --build`). On-screen
confirmation pending: open the 30 Aug session in Slice C, press `y`, and confirm
the paddle squares up in the XY plane and rolls about its shaft under fused.
