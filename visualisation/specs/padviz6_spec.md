...
**Verification.** Compiles clean (`processing-java --build`). On-screen
confirmation pending: run the wizard from Step 1 and confirm Step 3 shows the
paddle dimensions with working accept / edit, and that the built sidecar carries
